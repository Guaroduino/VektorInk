...
var require_tess2 = __commonJS({
  "node_modules/tess2/src/tess2.js"(exports, module) {
    "use strict";
    var Tess2 = {};
      ...
      tessellateMonoRegion_: function(mesh, face) {
        ...
        while (up.Lnext !== lo) {
          if (Geom.vertLeq(up.Dst, lo.Org)) {
            while (lo.Lnext !== up && (Geom.edgeGoesLeft(lo.Lnext) || Geom.edgeSign(lo.Org, lo.Dst, lo.Lnext.Dst) <= 0)) {
              var tempHalfEdge = mesh.connect(lo.Lnext, lo);
              lo = tempHalfEdge.Sym;
            }
            lo = lo.Lprev;
          } else {
            while (lo.Lnext != up && (Geom.edgeGoesRight(up.Lprev) || Geom.edgeSign(up.Dst, up.Org, up.Lprev.Org) >= 0)) {
...
var require_tess22 = __commonJS({
  "node_modules/tess2/index.js"(exports, module) {
    module.exports = require_tess2();
  }
});
export default require_tess22();
//# sourceMappingURL=tess2__js.js.map
